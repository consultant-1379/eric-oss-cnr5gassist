{{- /*
Generic function for merging annotations and labels (version: 1.0.0)
{
    context: string
...
*/ -}}
{{- define "eric-oss-5gcnr.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-5gcnr.mergeAnnotations" -}}
  {{- include "eric-oss-5gcnr.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-5gcnr.mergeLabels" -}}
  {{- include "eric-oss-5gcnr.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
